    ...
    def predict_measurements(self,
        ...
        try:
            ...
            if apparel_type == "tshirt":
                ...
                upper_body_keys = ['chest', 'shoulder-breadth', 'bicep', 'forearm', 'wrist', 'arm-length', 'shoulder-to-crotch']
                result["upper_body_measurements"] = {k: measurements[k] for k in upper_body_keys if k in measurements}
                ...
                lower_body_keys = ['waist', 'hip', 'thigh', 'calf', 'ankle', 'leg-length']
                result["lower_body_measurements"] = {k: measurements[k] for k in lower_body_keys if k in measurements}
